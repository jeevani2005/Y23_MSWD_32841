...
export default function Navbar() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ height: '64px', backgroundColor: '#800000' }}>
      ...
      {menuOpen && (
        ...
        >
          <List>
            ...
            <ListItem button component={Link} to="/skill" onClick={handleMenuClose}>
              <ListItemText primary="Skill" />
            </ListItem>
            <ListItem button component={Link} to="/attendence" onClick={handleMenuClose}>
